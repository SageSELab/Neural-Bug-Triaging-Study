...
for f in range(1, 11):
    df_train = pd.read_csv(f"../Data/mozilla_core_fold{f}_train.csv")
    df_test = pd.read_csv(f"../Data/mozilla_core_fold{f}_test.csv")
    ...
    np.save(f"pred_mozilla_core_distilbert_fold{f}.npy", pred)