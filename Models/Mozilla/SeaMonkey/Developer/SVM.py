...
project_name = "mozilla_seamonkey_fold"
n_components = 11000
...
for f in range(10,11):
    ...
    unique_assign_to = dict([(v, k) for k,v  in zip(range(0, len(df_train["Assignee"].unique())), df_train["Assignee"].unique())])
    ...
    np.save(f"pred_mozilla_seamonkey_svm_fold{f}.npy", pred)