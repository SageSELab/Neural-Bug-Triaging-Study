...
for f in range(1, 11):
    df_train = pd.read_csv(f"../Data/eclipse_jdt_fold{f}_train.csv")
    df_test = pd.read_csv(f"../Data/eclipse_jdt_fold{f}_test.csv")
    ...
    np.save(f"pred_eclipse_jdt_distilbert_fold{f}.npy", pred)